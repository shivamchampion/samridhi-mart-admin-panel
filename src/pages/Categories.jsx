      ...
      <div className="bg-white rounded-lg border overflow-hidden">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {categories.map((category) => (
                <tr key={category.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm text-gray-500">{category.createdAt}</span>
                  </td>
        ...
        <div className="px-6 py-3 flex items-center justify-between border-t">
          <div className="text-sm text-gray-500">
            Showing <span className="font-medium">1</span> to <span className="font-medium">5</span> of <span className="font-medium">5</span> categories
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <select 
                    className="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    defaultValue={selectedCategory?.active ? 'active' : 'inactive'}
                  >
